...
<div class="modal fade" id="updateKeluarga" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-group">
					...
					<input style="height:40px" class="form-control input-sm" type="text" name="no_rumah" value="<?= $warga->no_rumah ?>">
					<!-- <small class="form-text text-danger"><?= form_error('no_rumah'); ?></small> -->
				</div>
				<div class="form-group">
					<label>No KK</label>
					<input style="height:40px" class="form-control input-sm" type="text" name="no_kk" value="<?= $warga->no_kk ?>">
				</div>
				<div class=" form-group">
					<label>Alamat</label>
					<input style="height:40px" class="form-control input-sm" type="text" name="alamat" value="<?= $warga->alamat ?>">
				</div>
				<div class=" form-group">
					<label>Rt</label>
					<input style="height:40px" class="form-control input-sm" type="text" name="rt" value="<?= $warga->rt ?>">
				</div>
				<div class=" form-group">
					<label>Rw</label>
					<input style="height:40px" class="form-control input-sm" type="text" name="rw" value="<?= $warga->rw ?>">
				</div>
				<div class=" form-group">
					<label>Jumlah Keluarga</label>
					<input style="height:40px" class="form-control input-sm" type="number" name="jumlah_keluarga" value="<?= $warga->jumlah_keluarga ?>">
				</div>
				<div class=" form-group">
					<label>Status Rumah</label>
					<input disabled style="height:40px" class="form-control input-sm" value="<?= $warga->status_rumah ?>">
				</div>
				<div class="form-group">
					<label>Status Rumah</label>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-group d-flex justify-content-center">
					<img src="<?php echo base_url('uploads/' . $this->session->file_kk) ?>" alt="..." class="img-thumbnail mb-2">
				</div>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
<div class="modal fade" id="lengkapiKeluarga" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
		...
		<div class="row mt-4">
			...
			if ($warga->jumlah_keluarga == 0 || $warga->no_kk == NULL || $warga->alamat == NULL || $warga->rt == NULL || $warga->rw == NULL) { ?>
				<div class="col-md-5 text-center my-4 ml-4 d-flex flex-column justify-content-center">
					...
					<div>
						<button class="btn btn-main" style="width: 200px;" data-target="#lengkapiKeluarga" data-toggle="modal">Lengkapi Data</button>
					</div>
				</div>
			<?php	} else { ?>
				<div class="col-md-5 text-center my-4 ml-4 d-flex flex-column justify-content-center">
					...
					<div>
						<button class="btn btn-main" style="width: 200px;" data-target="#updateKeluarga" data-toggle="modal">Edit Data</button>
					</div>
				</div>
			<?php } ?>
		</div>
											...
											<?php if ($this->session->status == "Kepala Keluarga") : ?>
												<td>
													<a href="<?= base_url('user/warga/info_hunian/' . $warga->id_detail_warga) ?>">
														<button class="btn btn-primary btn-sm btn-edit"><i class="fas fa-info"></i></button>
													</a>
