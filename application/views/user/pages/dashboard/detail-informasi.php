		...
		<div class="row">
			<div class="col-md-10 mx-auto">
				<div class="text-justify p-5 shadow" style="height: 1000px">
					...
					<p>
						<img src="<?= base_url('uploads/pengumuman/') .$pengumuman['thumbnail'] ?>" class="img-thumbnail float-left mr-3" alt="<?= $pengumuman['thumbnail'] ?>" style="width: 300px;"><?= $pengumuman['isi'] ?>
					</p>
					<a href="<?= base_url('user/dashboard/informasi') ?>" class="">Kembali</a>
				</div>
			</div>
		</div>
	</div>
