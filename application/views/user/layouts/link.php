...
<!-- animate.css -->
<link rel="stylesheet" href="<?php echo base_url('assets/user/') ?>plugins/animate-css/animate.css">
<!-- Magnify Popup -->
...
<style>
	@font-face {
		...
		src: url("https://fonts.googleapis.com/css?family=Barlow+Condensed:400,500,600,700|Montserrat|Poppins:400,500,600,700");
	}
