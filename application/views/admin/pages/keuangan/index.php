              ...
              <div class="card-box">
                ...
                <div class="table-responsive">
                  <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                    ...
                    <tbody>
                      <?php $no = 1; foreach ($keuangan as $uang):?>
                        <tr>
                          ...
                          <td>  <a href=" <?php echo base_url('Keuangan/detail_rekap/'.$uang->bulan.'/'.$uang->tahun)?>" class="ladda-button btn btn-primary" data-style="slide-up">
