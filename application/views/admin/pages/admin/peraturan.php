						...
						<tbody>
							...
							<?php foreach ($peraturan as $key) : ?>
								<tr>
									...
									<td>
										<a href="<?= base_url("admin/admin/updatePeraturan/$key[id]"); ?>" class="badge badge-success updatePeraturanModalButton" data-toggle="modal" data-target="#newPeraturanModal" data-id="<?= $key['id'] ?>">Edit</a>
										<a href="<?= base_url("admin/admin/deletePeraturan/$key[id]"); ?>" class="badge badge-danger" onclick="return confirm('Are you sure?');">Delete</a>
									</td>
								</tr>
								<?php $no++; ?>
							<?php endforeach ?>
