<div class="content-page">
  ...
  <form method="POST" enctype="multipart/form-data"
                    action="<?php echo base_url('pemasukan/update_data_pemasukan/').$pemasukan[0]->id_pemasukan; ?>" >
                    ...
                    <?php if(!empty($this->session->flashdata('error'))){
                      ...
                      <div class="form-group row">
                       ...
                       <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                          <a href="http://localhost/warga_berseri<?php echo $pemasukan[0]->bukti_pemasukan; ?>" target="_blank">
                          <img src="http://localhost/warga_berseri<?php echo $pemasukan[0]->bukti_pemasukan; ?>" style = "height: 70%; width: 50%; float: left;"></a>
                        </div>
                      </div>
                      <div class="form-group row">
