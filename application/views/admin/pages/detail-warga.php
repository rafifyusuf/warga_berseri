...
<!-- ============================================================== -->
<div class="modal fade overflow-auto" id="addWarga" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
                            ...
                            <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button data-toggle="modal"
                                                data-target="#openImageKK<?php echo $warga->id_detail_warga ?>"
                                                class="ladda-button btn btn-info" data-style="slide-up">
                                                <i class="mdi mdi-eye-outline"></i> Lihat
                                            </button>
                                        </td>
                                        <td>
                                            <button data-toggle="modal"
                                                data-target="#viewDetail<?php echo $warga->id_detail_warga ?>"
                                                class="ladda-button btn btn-primary" data-style="slide-up">
                                        ...
                                        <td>
                                            <center>
                                                ...
                                                <input type="hidden" name="id_detail_warga"
                                                    value="<?= $warga->id_detail_warga ?>">
                                                <input type="hidden" name="no_rumah" value="<?= $no_rumah ?>">
                                                <button type="submit" class="ladda-button btn btn-warning mb-1"
                                                    data-style="slide-up">
                                                ...
                                                <?= form_close() ?>
                                                <?php } else { ?>
                                                <button disabled class="ladda-button btn btn-success"
                                                    data-style="slide-up">
                                                    <i class="mdi mdi-account-check-outline"></i>
                                                    Terverifikasi
                                                </button>
                                                <?php		} ?>
                                                <a href="<?php echo base_url('admin/warga/delete_warga/' . $warga->id_detail_warga) ?>"
                                                    class="ladda-button btn btn-danger" data-style="slide-up">
                                    ...
                                    <div class="modal fade overflow-auto"
                                        id="openImageKK<?php echo $warga->id_detail_warga ?>" tabindex="-1"
                                    ...
                                    <div class="modal fade" id="viewDetail<?php echo $warga->id_detail_warga ?>"
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input disabled style="height:40px"
                                                            ...
                                                            value="<?php echo $warga->nama_warga ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>NIK</label>
                                                        <input disabled style="height:40px"
                                                            class="form-control input-sm" type="text"
                                                            value="<?php echo $warga->nik ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>No Hp</label>
                                                        <input disabled style="height:40px"
                                                            class="form-control input-sm" type="text"
                                                            value="<?php echo $warga->no_hp ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Tempat, Tanggal Lahir</label>
                                                        <input disabled style="height:40px"
                                                            class="form-control input-sm" type="text"
                                                            value="<?php echo $warga->tempat_lahir ?>, <?php echo $warga->tanggal_lahir ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Agama</label>
                                                        <input disabled style="height:40px"
                                                            class="form-control input-sm" type="text"
                                                            value="<?php echo $warga->agama ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Jenis Kelamin</label>
                                                        <input disabled style="height:40px"
                                                            class="form-control input-sm" type="text"
                                                            value="<?php echo $warga->jenis_kelamin ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Status Perkawinan</label>
                                                        <input disabled style="height:40px"
                                                            class="form-control input-sm" type="text"
                                                            value="<?php echo $warga->status_perkawinan ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Hubungan Keluarga</label>
                                                        <input disabled style="height:40px"
                                                            class="form-control input-sm" type="text"
                                                            value="<?php echo $warga->hubungan_keluarga ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Status</label>
                                                        <input disabled style="height:40px"
                                                            class="form-control input-sm" type="text"
                                                            value="<?php echo $warga->status ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Pekerjaan</label>
                                                        <input disabled style="height:40px"
                                                            class="form-control input-sm" type="text"
                                                            value="<?php echo $warga->pekerjaan ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Pendidikan</label>
                                                        <input disabled style="height:40px"
                                                            class="form-control input-sm" type="text"
                                                            value="<?php echo $warga->pendidikan ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Status Hunian</label>
                                                        <input disabled style="height:40px"
                                                            class="form-control input-sm" type="text"
                                                            value="<?php echo $warga->status_hunian ?>">
                                                    </div>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary"
