    <div class="content-page">
        <div class="content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                	<div class="col-lg-12">
                        <a href="<?= base_url('KeluhanAspirasi/clearKeluhan') ?>" class="btn btn-danger mb-3" onclick="return confirm('Are you sure?');">Bersihkan Keluhan</a>
                				...
                				<?php foreach ($keluhan as $key): ?>
                    				...
                    				<tr class="<?= $color ?>">
                    					...
                    					<td>
                                            ...
                                            <a href="<?= base_url("Admin/deleteKeluhan/$key[id]"); ?>" class="badge badge-danger" onclick="return confirm('Are you sure?');">Delete</a>
                    					</td>
                    				</tr>
                    			<?php $no++; ?>
                				<?php endforeach ?>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <a href="<?= base_url('KeluhanAspirasi/clearAspirasi') ?>" class="btn btn-danger mb-3" onclick="return confirm('Are you sure?');">Bersihkan Aspirasi</a>
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    <th scope="col">#</th>
                                ...
                                <?php foreach ($aspirasi as $key): ?>
                                    ...
                                    <tr class="<?= $color ?>">
                                        ...
                                        <td>
                                            ...
                                            <a href="<?= base_url("Admin/deleteAspirasi/$key[id]"); ?>" class="badge badge-danger" onclick="return confirm('Are you sure?');">Delete</a>
                                        </td>
                                    </tr>
                                <?php $no++; ?>
                                <?php endforeach ?>
...
<div class="modal fade" id="newAspirasiModal" tabindex="-1" aria-labelledby="newAspirasiModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('KeluhanAspirasi/updateAspirasi') ?>" method="post">
