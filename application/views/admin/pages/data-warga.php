                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group mr-2">
                                        <button data-toggle="modal" data-target="#addWarga" class="btn btn-secondary"><i
                                                class="mdi mdi-plus-circle mr-2"></i> Tambah Data Warga</button>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $warga->jumlah_keluarga ?> Anggota</td>
                                        <td><?php echo $warga->status_rumah ?></td>
                                        <td><?php echo $warga->rt ?> / <?php echo $warga->rw ?></td>
                                        <td width='110px'>
                                            <button data-toggle="modal"
                                                data-target="#openImageKK<?php echo $warga->id_warga ?>"
                                        ...
                                        <td width='310px'>
                                            <center>
                                                <a href=" <?php echo base_url('admin/warga/detail_warga/' . $warga->id_warga) ?>"
                                                    class="ladda-button btn btn-primary" data-style="slide-up">
                                                    <i class="mdi mdi-information-outline"></i> Info Warga
                                                </a>
                                                <a href=" <?php echo base_url('admin/kendaraan/index/' . $warga->id_warga . '/' . $warga->no_rumah) ?>"
                                    ...
                                    <div class="modal fade overflow-auto" id="openImageKK<?php echo $warga->id_warga ?>"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-group d-flex justify-content-center">
                                                        <img src="<?php echo 'http://localhost/warga_berseri/user/uploads/' . $warga->file_kk ?>"
