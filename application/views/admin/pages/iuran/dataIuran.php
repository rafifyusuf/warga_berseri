								...
								<div class="col">
									<div class="form-group">
										<h6 class="font-weight-bold text-primary">
											<a href="<?php echo base_url(); ?>admin/iuran/tambah_iuran">
												<input class="btn btn-primary" type="submit" value=" Tambah Iuran +">
											</a>
										</h6>
									</div>
								</div>
									...
									foreach ($iuran as $warga) : ?>
										<tr>
											...
											<?php if ($warga->bukti_pembayaran != "") : ?>
												<td>
													<center>
														<img src="<?= base_url($warga->bukti_pembayaran); ?>" style="width: 35%; height: 20%;">
													</center>
												</td>
											<?php endif; ?>
											...
											<?php if ($warga->status_iuran == "Belum Diverifikasi") : ?>
												<td>
													<table>
														<tr>
															<center>
																<td><a href="<?php echo base_url(); ?>admin/iuran/verifikasi_iuran/<?php echo $warga->no_tagihan; ?>"><button type="button" class="btn btn-primary">Verifikasi Iuran</button></a> </td>
																<td><a href="<?php echo base_url(); ?>admin/iuran/verifikasi_iuran/<?php echo $warga->no_tagihan; ?>"><button type="button" class="btn btn-primary">Tolak</button></a></td>
															</center>
														</tr>
													</table>
												</td>
