					...
					<div class="card-body">
						<div class="text-center">
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="text" name="nama" class="form-control" value="<?php echo $warga->nama_warga; ?>" readonly>
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<select class="form-control" name="status_aspirasi" disabled="">
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<textarea class="form-control" readonly="" name="respon_aspirasi"><?php echo $aspirasi_masuk[0]->respon_aspirasi; ?></textarea>
								</div>
							</div>
							<div style="text-align: right" class="col-sm-12">
								<a href="<?php echo base_url(); ?>admin/aspirasi/dataAspirasi"><button class="btn btn-primary">Kembali</button></a>
							</div>
