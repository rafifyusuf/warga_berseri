							...
							<table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
								...
								<tbody>
									...
									foreach ($aspirasi_masuk as $aspirasi) : ?>
										<tr>
											<td><?php echo $no++ ?></td>
											<td><?php echo $aspirasi->nama_warga ?></td>
											...
											<td>
												<center>
													<a href="<?= base_url('admin/aspirasi/detail_aspirasi/' . $aspirasi->no_tiket) ?>" class="ladda-button btn btn-success" data-style="slide-up">
