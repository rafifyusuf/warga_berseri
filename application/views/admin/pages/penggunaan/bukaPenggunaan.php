                  ...
                  <div class="text-center">
                    <form>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <img src="http://localhost:8080/warga_berseri<?php echo $penggunaan[0]->bukti_pengeluaran; ?>" style = "height: 70%; width: 50%;" >
                        </div>
                      </div>
                       <div class="form-group row">
                        ...
                        <a href="<?php echo base_url('Penggunaan/') ?>" style="text-decoration: none;"><button class="btn btn-primary" type="button">Kembali</button></a>
                        </div>
               <!--      </form> -->
                  </div>
                </div>
